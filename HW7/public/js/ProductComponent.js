    ...
    template: `
		...
		<article class="brand-products-item">
				<div class="products-item-photo-wrp">
						<a class="products-item-link">
								<img class="products-item-photo" :src="img" alt="product description" height="420">
						</a>
				</div>
				<div class="products-item-txt-wrp">
						<h3 class="products-item-title txt">{{product.product_name}} </h3>
						...
						<p class="products-item-price txt"> $ {{product.price}}</p>
				</div>
				<button class="products-item-btn txt" type="button" @click="$emit('add-product', product)">
